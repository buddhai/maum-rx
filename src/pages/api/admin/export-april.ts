...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  try {
    ...
    const start = Timestamp.fromDate(new Date('2026-03-31T15:00:00.000Z')) // 한국시간 2026-04-01 00:00
    const end = Timestamp.fromDate(new Date('2026-04-30T15:00:00.000Z'))   // 한국시간 2026-05-01 00:00
