...
// ── 코드 생성 (불교·명상 한글 조합: 3글자 + 2글자) ──────────────────
// 앞 단어(3글자) × 뒤 단어(2글자) = 80 × 80 = 6,400가지 조합
// 앞뒤 의미가 완전히 같은 조합은 제외하므로 실제 약 6,320가지
// 최종 코드는 공백 없는 5글자 형식입니다. 예: 연꽃마음, 자비숨결
export const CODE_PREFIX = [
  ...
  '고요한', '맑은빛', '깊은숨', '푸른달', '하얀별', '따뜻한',
  '잔잔한', '은은한', '새벽의', '바람의', '구름의', '햇살의',
  '달빛의', '물결의', '숲속의', '마음의', '숨결의', '향기의',
  '차향의', '기도의', '침묵의', '온기의', '미소의', '쉼표의',
  '오늘의', '지금의', '순간의', '내면의', '비움의', '채움의',

  '한걸음', '첫마음', '참마음', '선한빛', '밝은길', '고운숨',
  '맑은길', '조용한', '담담한', '단단한', '부드런', '넉넉한',
  '평온한', '가벼운', '새로운', '깨어난', '머무는', '흐르는',
  '피어난', '스미는'
]
